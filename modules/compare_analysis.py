...
from utils.report_generator import generate_compare_report
        ...
        if selected_type:
            ...
            if device1 and device2:
                ...
                if image1_data and image2_data:
                    df1 = pd.DataFrame([image1_data], columns=['id', 'image_path', 'device_name', 'device_type', 'location', 'capture_time', 'ambient_temp', 'load_rate', 'tmax', 'tmin', 'tavg', 'delta_t', 'defect_level', 'diagnosis_result', 'relative_temp', 'hotspots', 'recommendation', 'time_limit'])
                    df2 = pd.DataFrame([image2_data], columns=['id', 'image_path', 'device_name', 'device_type', 'location', 'capture_time', 'ambient_temp', 'load_rate', 'tmax', 'tmin', 'tavg', 'delta_t', 'defect_level', 'diagnosis_result', 'relative_temp', 'hotspots', 'recommendation', 'time_limit'])
